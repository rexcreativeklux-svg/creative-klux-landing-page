        ...
        <section className="relative overflow-hidden py-2 sm:py-3 md:py-2 lg:py-2">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-4xl mx-auto mb-12 md:mb-16">
                    ...
                    {/* Main Headline */}
                    <h1 className="text-xl sm:text-4xl md:text-4xl lg:text-6xl xl:text-7xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight px-4">
                        All you need to power{" "} <br />
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3  mx-auto  px-4">
                        <div className="flex justify-between gap-4 sm:max-w-xl items-center bg-white rounded-lg px-3 sm:px-4 py-3 shadow-xl border border-gray-200 w-full sm:flex-1 ">
                            <div className='flex flex-row'>
                                <div className="flex items-center space-x-1 sm:space-x-2 text-gray-600 shrink-0">
                                    <svg width="20" height="20" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
                                        ...
                                        <circle cx="22" cy="10" r="4" fill="url(#grad1)" />
                                        <circle cx="10" cy="22" r="4" fill="url(#grad1)" />
                                        <circle cx="22" cy="22" r="4" fill="url(#grad1)" />
                                        <defs>
                                    ...
                                    <span className="text-xs sm:text-sm font-medium whitespace-nowrap">CreativeKlux/</span>
                                </div>
                                <input
                                    type="text"
                                    ...
                                    className="outline-none ml-1 text-gray-900 placeholder-gray-400 w-full text-sm sm:text-base"
                                />
                            </div>

                            <button className="bg-[#1447e6] hover:bg-blue-700 text-white px-6 sm:px-8 py-3 rounded-lg font-semibold transition shadow-lg shadow-blue-600/30 flex items-center justify-center whitespace-nowrap text-sm sm:text-base">
                                Claim your username
                ...
                <div className="relative max-w-6xl mx-auto px-4">
                    ...
                    <div className="absolute bottom-10 left-28 hidden xl:block animate-float-delayed">
                        <div className="bg-gradient-to-br from-orange-500 to-pink-500 rounded-2xl p-4 shadow-xl w-64">
