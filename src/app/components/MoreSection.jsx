...
export default function MoreSection() {
  const features = [
    ...
    { title: 'Presentation Decks',            description: 'Create stunning presentation decks that wow your audience', image: '/images/presentation-deck.png',       bg: 'bg-linear-to-br from-amber-50 to-orange-100' },
