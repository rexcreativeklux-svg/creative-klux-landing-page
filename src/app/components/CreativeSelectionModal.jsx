                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex gap-5 flex-row justify-between border-b border-gray-200 flex-wrap">
                                {TABS.map((tab) => (
                                    ...
                                    >
                                        {/* <IconWrapper className="w-4 h-4 text-gray-600">
                                            <tab.icon />
                                        </IconWrapper> */}
                                        {tab.name}
                                    </button>
                                ...
                                <div className="grid grid-cols-3 gap-3 animate-in fade-in duration-300">
                                    {tabCreatives.map((item) => (
                                        <button
                                            ...
                                            className={`px-3 py-2 rounded-lg border bg-gray-100 cursor-pointer flex items-center gap-2 transition-all duration-200 ${
