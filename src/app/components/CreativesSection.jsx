    ...
    const creatives = [
        {
            ...
            features: [
                { icon: '📸', title: 'Image Ads Creatives', description: 'Eye-catching static ads with proven templates that boost CTR by 3x' },
                { icon: '🎬', title: 'Video Ads Creatives', description: 'Engaging video ads optimized for mobile feeds and stories' },
                { icon: '🎮', title: 'Interactive Ads Creatives', description: 'Swipeable carousels and polls that drive 5x more engagement' },
                { icon: '🕹️', title: 'Playable Ads Creatives', description: 'Mini-game ads that let users try before they buy' },
            ]
        },
        {
            id: 'social-content',
        ...
        },
        {
            ...
            features: [
                { icon: '🎨', title: 'Logos & Brand Identity', description: 'Memorable logos and complete brand kits in your signature style' },
                { icon: '🎴', title: 'Business Cards', description: 'Premium contact cards that make lasting first impressions' },
                { icon: '🎯', title: 'Banners (Print & Digital)', description: 'High-resolution banners for events, websites, and storefronts' },
