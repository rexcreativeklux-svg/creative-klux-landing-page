...
const FLOATING_CARDS = [
  ...
  },
  {
    ...
    content: {
      type: "platform",
      platforms: ["FB", "IG", "TT"],
      label: "Auto-published to 3 platforms",
    },
  },
  {
    side: "right",
      ...
      {content.type === "metric" && (
        <div>
          ...
          <div className="mt-2 h-1 bg-gray-100 rounded-full overflow-hidden">
            <div
              className="h-full rounded-full w-4/5"
        ...
        <div>
          <div className="flex gap-1.5 mb-2">
            {content.platforms.map((p, i) => (
              <div
                key={i}
                className="w-7 h-7 rounded-lg bg-gray-900 text-white text-[10px] font-bold grid place-items-center"
              >
                {p}
              </div>
            ))}
      ...
      {content.type === "rating" && (
        <div>
          <div className="text-amber-400 text-sm mb-1">
            {"★".repeat(content.stars)}
          </div>
          <div className="text-xs text-gray-600 leading-relaxed">
            {content.text}
          </div>
          <div className="flex items-center gap-1.5 mt-2">
            <div className="w-5 h-5 rounded-full bg-indigo-500 grid place-items-center text-white text-[9px] font-bold">
              S
            </div>
  ...
  return (
    <>
      ...
      >
        ...
        <header>
          <nav
            className={`flex items-center justify-between px-10 h-16 border-b border-black/[0.07] bg-[#f7f7f5]/85 backdrop-blur-xl sticky top-0 z-50 transition-shadow duration-200 ${isScrolled ? "shadow-[0_1px_16px_rgba(0,0,0,0.07)] bg-[#f7f7f5]/95" : ""}`}
          >
            {/* Logo */}
            <Link
              href="/"
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="flex flex-col items-center text-center px-6 pt-20 pb-16 max-w-[740px] mx-auto">
            ...
            <p className="text-[17px] font-light text-[#777] leading-[1.65] max-w-[440px] mb-10">
              Paste your product URL. Get ads, social posts, and brand designs —
              tailored to your brand, ready to publish.
            </p>
            ...
            <form className="w-full max-w-[480px]" onSubmit={handleSubmit}>
              ...
              <div className="mt-3.5 flex justify-center gap-5 text-[12px] text-[#b0b0a8]">
                {["No credit card", "Free to start", "Export anywhere"].map(
                  (t) => (
            ...
            <div className="flex items-center gap-2.5 mt-10 text-[13px] text-[#888]">
              ...
              <span className="text-amber-400 tracking-[-2px] text-sm">
                ★★★★★
              </span>
              <span>
                Loved by <strong className="text-[#111]">50,000+</strong>{" "}
                creators
              </span>
            </div>
            ...
            <div className="mt-10 flex flex-col items-center gap-3">
              <p className="text-[11px] uppercase tracking-widest text-[#bbb] font-medium">
                Trusted by teams at
              </p>
